...
**Strong prediction:** The probability of transitioning to a targeted state increases: prediction values improve from $\color{orange}{\langle {\cal P} \rangle \geq 1/N} \to (2N/3) \langle {\cal P} \rangle \geq 2/3$ as more QDFs (at various scales: $events \leftarrow 2n$ $ events \leftarrow 2n qubit $) are used.
